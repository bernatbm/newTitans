            ...
            <div>
                <h2 class="pa-h2">Crear reserva</h2>
                    ...
                    <form class="pa-form" action="crearReserva.php" method="POST">
                        ...
                        <div class="pa-submit">
                                <button class="pa-hotel-aeropuerto-submit" id="hotel-aeropuerto" type="submit">Confirmar reserva</button>
                            </div>
                        ...
                        <div class="pa-ida-vuelta-submit">
                                <button id="ida-vuelta" type="submit">Confirmar reserva</button>
                            </div>
